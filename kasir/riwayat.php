                                ...
                                <table class="table table-bordered  mb-0">
                                    ...
                                    <?php foreach ($dataTransaksi as $transaksi) : ?>
                                        ...
                                        if ($transaksi['status'] == 'diambil') {
                                            ...
                                            <td>
                                                <?php $idPelanggan = $transaksi['id_member']; ?>
                                                <?php $queryNama = "SELECT * FROM tb_member WHERE id = $idPelanggan";
                                            ...
                                            <td><?= $proses ?></td>
                                            <td>
                                                <button  type="button" class="btn btn-primary" ><a href="dtl_transaksi.php?idTransaksi=<?= $transaksi['id'] ?>&kode=<?= $transaksi['kode_invoice'] ?>" style="color: white;">Detail</a></button>
